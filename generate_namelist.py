...
def GCMVarying():
    ...
    namelist['gcm']['file'] = '/Users/xiyue/Dropbox/WORK/fms_analysis/forcing/f_data_tv_1_00x_ice_les_lat70_lon180.pkl'
    namelist['gcm']['lw_tau0_eqtr'] = 7.2
    namelist['gcm']['lw_tau0_pole'] = 1.8

    namelist['surface'] = {}
    namelist['surface']['gcm_flux'] = False
    ...
    namelist['surface_budget']['sea_ice'] = True
...
def GCMMean():
    ...
    namelist['gcm']['lw_tau0_eqtr'] = 2.88
    namelist['gcm']['lw_tau0_pole'] = 0.72
